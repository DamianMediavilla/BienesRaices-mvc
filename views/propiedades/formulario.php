...
<fieldset>
    ...
    <select name="propiedad[vendedorId]" id="nombre_vendedor">
        ...
        <?php foreach($vendedores as $vendedor) { ?>
            <option <?php echo $propiedad->vendedorId === $vendedor->idvendedores ? 'selected' : '' ?> value="<?php echo s($vendedor->idvendedores); ?>"><?php echo s($vendedor->nombre) . " " . s($vendedor->apellido); ?>
        <?php  } ?>
    </select>
