    ...
    <main class="contenedor seccion">
        ...
        <table class="propiedades">
            ...
            <tbody> <!-- Mostrar los Resultados -->
                ...
                <tr>
                    <td><?php echo $propiedad->idProp; ?></td>
                    <td><?php echo $propiedad->titulo; ?></td>
                    <td> <img src="imagenes/<?php echo $propiedad->imagen; ?>" class="imagen-tabla"> </td>
                    <td>$ <?php echo $propiedad->precio; ?></td>
                    <td>
                        <form method="POST" action="/admin" class="w-100">
                            <input type="hidden" name="id" value="<?php echo $propiedad->idProp; ?>">
                            <input type="hidden" name="tipo" value="propiedad">
                            <input type="submit" class="boton boton-rojo block" value="Eliminar">
                        </form>
                        
                        <a href="admin/propiedades/actualizar?id=<?php echo $propiedad->idProp; ?>" class="boton boton-amarillo">Actualizar</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <table class="propiedades">
        ...
        <tbody> <!-- Mostrar los Resultados -->
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="/admin" class="w-100">
                        <input type="hidden" name="id" value="<?php echo $vendedor->ivendedores; ?>">
